<template>
  <div>
    <h1>Simulation 1</h1>
    <button @click="toggleScreen">Schirm ein-/ausblenden</button>
    <button @click="shootSingleElectron">Elektron feuern</button>
    <button @click="shoot100Electrons">100 Elektronen feuern</button>
    <button @click="toggleSpin">Elektronenspin (theoretisch) anzeigen</button>
    <div :style="{'visibility': loading ? 'hidden' : 'visible'}">
      <svg id="simulation" width="100%" height="100%" viewBox="0 0 10992 6071" version="1.1"
           xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve"
           style="fill-rule:evenodd;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:1.5;"><path id="screen" d="M10722.9,366.195l-1756.95,610l-0,4139.29l1756.95,697.143l0,-5446.43Z" style="fill:#e5e5e5;stroke:#000;stroke-width:23.37px;"/>
        <path id="pathUpScreen"
              d="M663.544,3065.29c0,0 3985.03,0 5014.16,0c158.935,0 316.675,-27.464 466.257,-81.182c835.436,-300.019 3700.49,-1328.91 3700.49,-1328.91"
              style="fill:none;"/>
        <path id="pathStraightScreen" d="M663.544,3060.8l9180.9,-0" style="fill:none;"/>
        <path id="pathDownScreen"
              d="M663.544,3060.8c0,-0 3985.03,-0 5014.16,-0c158.935,-0 316.675,27.465 466.257,81.182c835.436,300.019 3700.49,1328.91 3700.49,1328.91"
              style="fill:none;"/>
        <path id="pathUp"
              d="M663.544,3065.29c0,0 3985.03,0 5014.16,0c158.935,0 316.675,-27.464 466.257,-81.182c1042.28,-374.3 5333.63,-1915.4 5333.63,-1915.4"
              style="fill:none;"/>
        <path id="pathStraight" d="M663.544,3060.8l10814,-0" style="fill:none;"/>
        <path id="pathDown"
              d="M663.544,3060.8c0,-0 3985.03,-0 5014.16,-0c158.935,-0 316.675,27.465 466.257,81.182c1042.28,374.3 5333.63,1915.4 5333.63,1915.4"
              style="fill:none;"/>
        <g id="magnet"><rect id="rect195" x="5492.22" y="1994.03" width="1368.27" height="405.926" style="fill:#d40000;stroke:#000;stroke-width:18.89px;"/>
          <rect id="rect197" x="5492.22" y="4004.33" width="1368.27" height="405.926"
                style="fill:#d43837;stroke:#000;stroke-width:18.89px;"/>
          <path id="path199" d="M3808.39,3490.11l1210.81,369.76l1381.78,-0l-1692.59,-532.084l-900.007,162.324Z"
                style="fill:#c3c3c3;stroke:#000;stroke-width:18.89px;"/>
          <path id="path201" d="M3806.92,1870.15l894.677,278.034l6.805,1179.6l-901.482,162.593l-0,-1620.23Z"
                style="fill:#c3c3c3;stroke:#000;stroke-width:18.89px;"/>
          <rect id="rect203" x="5492.22" y="4004.33" width="1368.27" height="405.926"
                style="fill:#03458f;stroke:#000;stroke-width:18.89px;"/>
          <path id="path205"
                d="M3340.13,3753.04l0,-2435.56l1672.76,525.858l-0.093,-0l-0,405.898l-1205.88,-379.084l-0,1619.51l1.475,0.445l-1.475,0.269l1211.63,369.491l-5.751,-0l-0,403.968l-1672.67,-510.799Z"
                style="fill:#c3c3c3;stroke:#000;stroke-width:18.89px;"/>
          <path id="path207" d="M5012.79,2249.24l-0,-405.898l0.093,-0l479.337,150.689l-0,405.926l-479.43,-150.717Z"
                style="fill:#d40000;stroke:#000;stroke-width:18.89px;"/>
          <path id="path209" d="M5012.89,1843.34l-1672.76,-525.858l1368.27,-0l1672.76,525.858l-1368.27,-0Z"
                style="fill:#c3c3c3;stroke:#000;stroke-width:18.89px;"/>
          <path id="path211" d="M5012.89,1843.34l1368.27,-0l479.337,150.689l-1368.27,-0l-479.337,-150.689Z"
                style="fill:#d40000;stroke:#000;stroke-width:18.89px;"/>
          <path id="path213" d="M5492.22,4004.33l-473.017,-144.454l1381.78,-0l459.508,144.454l-1368.27,-0Z"
                style="fill:#03458f;stroke:#000;stroke-width:18.89px;"/>
          <path id="path215" d="M5012.79,3859.87l5.751,-0l473.679,144.454l-0,405.926l-479.43,-146.412l-0,-403.968Z"
                style="fill:#03458f;stroke:#000;stroke-width:18.89px;"/>
          <path id="path217"
                d="M6044.6,4299.78c-0.121,-5.289 1.68,-9.594 5.415,-12.934c3.734,-3.331 8.327,-5.001 13.77,-5.001c6.208,-0 11.651,3.525 16.338,10.577c6.451,9.557 12.22,16.042 17.28,19.438c10.764,7.051 26.402,10.568 46.912,10.568c19.634,-0 37.866,-4.212 54.708,-12.646c21.519,-10.819 32.283,-25.859 32.283,-45.112c0,-15.856 -9.046,-28.382 -27.157,-37.568c-15.32,-7.923 -34.253,-12.201 -56.79,-12.831c-20.007,-0.761 -37.035,-5.104 -51.095,-13.027c-17.981,-10.197 -26.971,-24.792 -26.971,-43.794c0,-22.398 12.79,-42.847 38.37,-61.348c24.432,-17.499 49.695,-26.239 75.779,-26.239c12.286,-0 26.149,2.078 41.6,6.226c20.511,5.409 30.771,12.33 30.771,20.764c-0,11.079 -5.695,16.618 -17.094,16.618c-5.069,-0 -13.929,-1.355 -26.588,-4.064c-12.669,-2.709 -22.481,-3.999 -29.445,-3.869c-19.755,0.25 -36.531,5.094 -50.33,14.539c-14.181,9.687 -21.276,21.452 -21.276,35.295c0,10.447 9.373,17.805 28.11,22.082c6.965,1.642 20.455,3.155 40.461,4.537c28.997,2.134 51.655,11.199 67.993,27.176c14.947,14.605 22.415,32.41 22.415,53.425c0,29.95 -13.929,53.861 -41.787,71.731c-24.189,15.485 -52.234,23.223 -84.143,23.223c-23.172,0 -44.383,-4.407 -63.633,-13.212c-23.545,-10.828 -35.513,-25.673 -35.896,-44.554Z"
                style="fill:#fff;fill-rule:nonzero;"/>
          <path id="magnetN"
                d="M6291.42,2301.23c-0,6.04 -1.009,16.107 -3.035,30.2c-2.025,12.712 -8.803,19.067 -20.324,19.067c-6.964,0 -15.264,-4.527 -24.88,-13.592c-51.542,-48.452 -110.675,-118.355 -177.408,-209.718l-0.942,42.847l-0.57,43.042c0,10.438 0.215,26.109 0.663,47.004c0.439,20.886 0.663,36.622 0.663,47.19c-0,33.847 -6.582,50.78 -19.755,50.78c-6.964,-0 -12.472,-2.208 -16.524,-6.606c-3.669,-3.906 -5.508,-8.564 -5.508,-13.973c-0,-5.289 0.411,-13.278 1.232,-23.976c0.822,-10.697 1.242,-18.686 1.242,-23.975c-0,-7.793 0.252,-19.466 0.756,-35.016c0.504,-15.541 0.756,-27.213 0.756,-35.016c0,-8.305 -0.187,-20.858 -0.569,-37.652c-0.374,-16.803 -0.57,-29.356 -0.57,-37.661c0,-7.933 -0.756,-19.725 -2.278,-35.396c-1.521,-15.671 -2.278,-27.464 -2.278,-35.397c0,-5.79 2.502,-11.069 7.506,-15.857c4.995,-4.778 10.662,-7.172 16.991,-7.172c6.713,0 15.012,7.302 24.89,21.897c31.527,46.939 59.889,85.954 85.086,117.037c30.015,36.872 62.933,72.111 98.773,105.708c0.373,-5.41 0.373,-13.398 -0,-23.966l-0.57,-23.79c0,-55.243 -2.156,-99.232 -6.46,-131.947c-0.504,-3.275 -2.213,-9.881 -5.126,-19.818c-2.539,-8.564 -3.799,-15.226 -3.799,-20.014c-0,-14.595 6.712,-21.897 20.128,-21.897c22.032,0 33.048,40.834 33.048,122.511c0,13.973 -0.186,34.831 -0.569,62.573c-0.373,27.752 -0.569,48.609 -0.569,62.583Z"
          ...
          <g id="electron"><use id="use260" xlink:href="#_Image1" x="0" y="0" width="120px" height="120px" transform="matrix(4.41167,0,0,4.41167,106.124,366.195)"/>
            <g id="g272"><path id="path262" d="M276.388,483.788c-0,22.336 3.609,42.815 3.609,66.166c-0,5.074 4.12,9.194 9.194,9.194c5.069,0 9.189,-4.12 9.189,-9.194c0,-23.351 -3.609,-43.83 -3.609,-66.166c0,-5.073 -4.12,-9.19 -9.194,-9.19c-5.069,0 -9.189,4.117 -9.189,9.19Z" style="fill:#000101;"/>
              ...
              <path id="path270"
                    ...
                    style="fill:none;stroke:#000101;stroke-width:14.56px;"/></g></g></g>
        <circle id="holeTop" cx="9844.45" cy="1655.2" r="57.431"/>
        <circle id="holeCenter" cx="9844.45" cy="3062.01" r="57.431"/>
        <circle id="holeBottom" cx="9844.45" cy="4470.89" r="57.431"/>
    ...
    <div>
      <h1>Zähler</h1>
      <h3>Oben: {{ top }} == {{(top / Math.max(top+bottom, 1) * 100).toFixed(2)}}%</h3>
      <h3>Unten: {{ bottom }} == {{(bottom / Math.max(top+bottom, 1) * 100).toFixed(2)}}%</h3>
    </div>
  </div>
</template>
