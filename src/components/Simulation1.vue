<template>
  <div>
    ...
    <button v-if="isSecond" class="absoluteButton" :disabled="currentlyAnimatedElectrons > 20 || disableButtons" id="shoot100Button" @click="shoot100Electrons">100 Elektronen erzeugen</button>
    ...
    <div :style="{'visibility': loading ? 'hidden' : 'visible'}">
      <svg id="simulation" width="100%" height="100%" viewBox="0 0 12859 7580" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
           xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:1.5;"><path id="screen" d="M12195.5,695.591l-1756.95,610l-0,4139.29l1756.95,697.143l0,-5446.43Z" style="fill:#e5e5e5;stroke:#000;stroke-width:23.37px;"/>
