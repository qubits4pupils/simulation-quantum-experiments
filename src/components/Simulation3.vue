...
<!--    <button @click="click">click</button>-->
    ...
    <button @click="shootElectrons" :disabled="state !== 'initialized'">shootElectrons</button>
    <button @click="toggleSpin" :disabled="state === 'animating'">show spin</button>
    <div :style="{'visibility': loading ? 'hidden' : 'visible'}">
      <svg id="simulation" ref="simulation" width="100%" height="100%" viewBox="0 0 13892 6859" version="1.1"
        ...
        <rect id="dropl3" x="404.231" y="3868.61" width="1568.52" height="1390.51" style="fill:#c6c4dd;"/>
        <rect id="dropl2" x="2256.15" y="3868.61" width="1568.52" height="1390.51" style="fill:#c6c4dd;"/>
        <rect id="dropl1" x="4108.08" y="3868.61" width="1568.52" height="1390.51" style="fill:#c6c4dd;"/>
        <rect id="dropl0" x="2931.36" y="1564.66" width="1568.52" height="1390.51" style="fill:#c6c4dd;"/>
        <rect id="dropr3" x="11770" y="3868.61" width="1568.52" height="1390.51" style="fill:#c6c4dd;"/>
        <rect id="dropr2" x="9918.07" y="3868.61" width="1568.52" height="1390.51" style="fill:#c6c4dd;"/>
        <rect id="dropr1" x="8066.15" y="3868.61" width="1568.52" height="1390.51" style="fill:#c6c4dd;"/>
        <rect id="dropr0" x="9001.19" y="1565.51" width="1568.52" height="1390.51" style="fill:#c6c4dd;"/>
        <path id="pathLeftStraight" d="M6419.33,4559.37l-6299.45,-0"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:19.72px;"/>
        <path id="pathLeftDown3"
              d="M6419.33,4559.37c0,-0 -3784.33,-0 -4915.33,-0c-207.657,-0 -412.636,46.88 -599.649,137.144c-316.574,152.798 -784.472,378.635 -784.472,378.635"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:19.72px;"/>
        <path id="pathLeftDown2"
              d="M6419.33,4559.37c0,-0 -2223.3,-0 -3062.46,-0c-207.658,-0 -412.636,46.88 -599.65,137.144c-734.177,354.359 -2637.35,1272.95 -2637.35,1272.95"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:19.72px;"/>
        <path id="pathLeftDown1"
              d="M6419.33,4559.37c0,-0 -763.643,-0 -1210.54,-0c-207.657,-0 -412.636,46.88 -599.649,137.144c-1027.43,495.899 -4489.27,2166.8 -4489.27,2166.8"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:19.72px;"/>
        <path id="pathLeftUp3"
              d="M6419.33,4563.86c0,0 -3784.33,0 -4915.33,0c-207.657,0 -412.636,-46.88 -599.649,-137.144c-316.574,-152.798 -784.472,-378.635 -784.472,-378.635"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:19.72px;"/>
        <path id="pathLeftUp2"
              d="M6419.33,4563.86c0,0 -2223.3,0 -3062.46,0c-207.658,0 -412.636,-46.88 -599.65,-137.144c-734.177,-354.359 -2637.35,-1272.95 -2637.35,-1272.95"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:19.72px;"/>
        <path id="pathLeftUp1"
              d="M6419.33,4563.86c0,0 -763.643,0 -1210.54,0c-207.657,0 -412.636,-46.88 -599.649,-137.144c-1027.43,-495.899 -4489.27,-2166.8 -4489.27,-2166.8"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:19.72px;"/>
        <path id="pathRightStraight" d="M7323.42,4559.37l6299.45,-0"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:6.47px;"/>
        <path id="pathRightDown3"
              d="M7323.42,4559.37c-0,-0 3784.33,-0 4915.33,-0c207.657,-0 412.636,46.88 599.649,137.144c316.574,152.798 784.472,378.635 784.472,378.635"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:6.47px;"/>
        <path id="pathRightDown2"
              d="M7323.42,4559.37c-0,-0 2223.3,-0 3062.46,-0c207.658,-0 412.636,46.88 599.65,137.144c734.177,354.359 2637.35,1272.95 2637.35,1272.95"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:6.47px;"/>
        <path id="pathRightDown1"
              d="M7323.42,4559.37c-0,-0 763.643,-0 1210.54,-0c207.657,-0 412.636,46.88 599.649,137.144c1027.43,495.899 4489.27,2166.8 4489.27,2166.8"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:6.47px;"/>
        <path id="pathRightUp3"
              d="M7323.42,4563.86c-0,0 3784.33,0 4915.33,0c207.657,0 412.636,-46.88 599.649,-137.144c316.574,-152.798 784.472,-378.635 784.472,-378.635"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:6.47px;"/>
        <path id="pathRightUp2"
              d="M7323.42,4563.86c-0,0 2223.3,0 3062.46,0c207.658,0 412.636,-46.88 599.65,-137.144c734.177,-354.359 2637.35,-1272.95 2637.35,-1272.95"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:6.47px;"/>
        <path id="pathRightUp1"
              d="M7323.42,4563.86c-0,0 763.643,0 1210.54,0c207.657,0 412.636,-46.88 599.649,-137.144c1027.43,-495.899 4489.27,-2166.8 4489.27,-2166.8"
              style="fill:none;stroke:#000;stroke-opacity:0;stroke-width:6.47px;"/>
        <g id="magnetl"><path id="rect168" d="M622.827,303.821l-610.675,-0l1.594,182.292l610.675,-0l-1.594,-182.292Z" style="fill:#d40000;stroke:#000;stroke-width:8.5px;"/>
          <path id="rect170" d="M630.717,1206.6l-610.675,-0l1.593,182.292l610.675,-0l-1.593,-182.292Z"
                style="fill:#d43837;stroke:#000;stroke-width:8.5px;"/>
          <path id="path172" d="M1380.21,975.675l-538.945,166.05l-616.708,0l753.332,-238.946l402.321,72.896Z"
                style="fill:#c3c3c3;stroke:#000;stroke-width:8.5px;"/>
          <path id="path174" d="M1374.51,248.192l-398.213,124.858l1.592,529.729l402.98,73.017l-6.359,-727.604Z"
                style="fill:#c3c3c3;stroke:#000;stroke-width:8.5px;"/>
          <path id="rect176" d="M630.717,1206.6l-610.675,-0l1.593,182.292l610.675,-0l-1.593,-182.292Z"
                style="fill:#03458f;stroke:#000;stroke-width:8.5px;"/>
          <path id="path178"
                ...
                style="fill:#c3c3c3;stroke:#000;stroke-width:8.5px;"/>
          <path id="path180"
                d="M837.808,418.429l-1.593,-182.279l-0.041,0l-213.347,67.671l1.594,182.292l213.387,-67.684Z"
                style="fill:#d40000;stroke:#000;stroke-width:8.5px;"/>
          <path id="path182" d="M836.174,236.15l744.502,-236.15l-610.675,0l-744.502,236.15l610.675,0Z"
                style="fill:#c3c3c3;stroke:#000;stroke-width:8.5px;"/>
          <path id="path184" d="M836.174,236.15l-610.675,0l-213.347,67.671l610.675,-0l213.347,-67.671Z"
                style="fill:#d40000;stroke:#000;stroke-width:8.5px;"/>
          <path id="path186" d="M630.717,1206.6l210.55,-64.871l-616.708,0l-204.517,64.871l610.675,-0Z"
                style="fill:#03458f;stroke:#000;stroke-width:8.5px;"/>
          <path id="path188" d="M844.13,1141.73l-2.571,0l-210.842,64.871l1.593,182.292l213.405,-65.75l-1.585,-181.413Z"
                style="fill:#03458f;stroke:#000;stroke-width:8.5px;"/>
          <path id="path190"
        ...
        <g id="magnetr"><rect id="rect195" x="960.526" y="312.101" width="610.689" height="181.174" style="fill:#d40000;stroke:#000;stroke-width:8.43px;"/>
          <rect id="rect197" x="960.526" y="1209.34" width="610.689" height="181.174"
                style="fill:#d43837;stroke:#000;stroke-width:8.43px;"/>
          <path id="path199" d="M208.996,979.834l540.413,165.032l616.718,-0l-755.438,-237.48l-401.693,72.448Z"
                style="fill:#c3c3c3;stroke:#000;stroke-width:8.43px;"/>
          <path id="path201" d="M208.338,256.813l399.313,124.093l3.038,526.48l-402.351,72.568l0,-723.141Z"
                style="fill:#c3c3c3;stroke:#000;stroke-width:8.43px;"/>
          <rect id="rect203" x="960.526" y="1209.34" width="610.689" height="181.174"
                style="fill:#03458f;stroke:#000;stroke-width:8.43px;"/>
          <path id="path205"
                ...
                style="fill:#c3c3c3;stroke:#000;stroke-width:8.43px;"/>
          <path id="path207" d="M746.546,426.006l0,-181.161l0.042,0l213.938,67.256l-0,181.174l-213.98,-67.269Z"
                style="fill:#d40000;stroke:#000;stroke-width:8.43px;"/>
          <path id="path209" d="M746.588,244.845l-746.588,-234.701l610.689,-0l746.588,234.701l-610.689,0Z"
                style="fill:#c3c3c3;stroke:#000;stroke-width:8.43px;"/>
          <path id="path211" d="M746.588,244.845l610.689,0l213.938,67.256l-610.689,-0l-213.938,-67.256Z"
                style="fill:#d40000;stroke:#000;stroke-width:8.43px;"/>
          <path id="path213" d="M960.526,1209.34l-211.117,-64.473l616.718,-0l205.088,64.473l-610.689,-0Z"
                style="fill:#03458f;stroke:#000;stroke-width:8.43px;"/>
          <path id="path215" d="M746.546,1144.87l2.567,-0l211.413,64.473l-0,181.173l-213.98,-65.346l0,-180.3Z"
                style="fill:#03458f;stroke:#000;stroke-width:8.43px;"/>
          <path id="path217"
        ...
        <g id="electronGroup"><g id="electrono"><path id="path222" d="M367.655,235.392l-149.25,-0l176.542,-235.392l176.542,235.392l-149.25,-0l-0,684.746c-0,15.062 -12.229,27.291 -27.292,27.291c-15.062,0 -27.292,-12.229 -27.292,-27.291l0,-684.746Z" style="fill:#326f56;"/><g
          id="g238"><use id="use224" xlink:href="#_Image1" x="0" y="0" width="120px" height="120px" transform="matrix(4.16667,0,0,4.16667,144.947,352.488)"/>
          <g id="g236"><path id="path226" d="M305.755,463.55c0,21.096 3.409,40.438 3.409,62.492c-0,4.791 3.887,8.679 8.679,8.679c4.792,-0 8.679,-3.888 8.679,-8.679c0,-22.055 -3.408,-41.396 -3.408,-62.492c-0,-4.792 -3.888,-8.683 -8.679,-8.683c-4.792,-0 -8.68,3.891 -8.68,8.683Z" style="fill:#000101;"/>
            <path id="path228"
          ...
          <g id="electronu"><path id="path241" d="M270.855,962.525l0,-684.746c0,-15.062 12.23,-27.291 27.292,-27.291c15.063,-0 27.292,12.229 27.292,27.291l-0,684.746l149.25,0l-176.542,235.392l-176.546,-235.392l149.254,0Z" style="fill:#326f56;"/>
            <g id="g257"><use id="use243" xlink:href="#_Image2" x="0" y="0" width="120px" height="120px" transform="matrix(4.16667,0,0,4.16667,48.1471,345.429)"/>
              <g id="g255"><path id="path245" d="M210.643,461.021c-0,21.096 3.408,40.437 3.408,62.492c0,4.791 3.892,8.683 8.684,8.683c4.787,-0 8.679,-3.892 8.679,-8.683c-0,-22.055 -3.409,-41.396 -3.409,-62.492c0,-4.792 -3.891,-8.679 -8.683,-8.679c-4.787,-0 -8.679,3.887 -8.679,8.679Z" style="fill:#000101;"/>
                <path id="path247"
                ...
                <path id="path253"
                      ...
                      style="fill:none;stroke:#000101;stroke-width:13.75px;"/></g></g></g>
          <g id="electron"><use id="use260" xlink:href="#_Image1" x="0" y="0" width="120px" height="120px" transform="matrix(4.16667,0,0,4.16667,100.23,345.858)"/>
